# Generated by Powerlevel10k configuration wizard on 2021-08-13 at 10:17 PDT.
...
# left frame, sparse, few icons, fluent, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#D8DEE9'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#C050D4'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#50A6D4'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='#A6D450'
